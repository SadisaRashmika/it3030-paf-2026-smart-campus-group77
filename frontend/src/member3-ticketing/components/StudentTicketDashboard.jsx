    ...
    <div className="space-y-5">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-slate-500">Tickets Workspace</p>
            <h2 className="mt-1 text-2xl font-bold text-slate-900">My Tickets</h2>
            <p className="mt-1 text-sm text-slate-600">Report campus incidents and track resolution progress.</p>
          </div>
          <button
            onClick={() => setCreateModalOpen(true)}
            className="flex items-center gap-2 rounded-xl bg-amber-500 px-5 py-3 text-sm font-bold text-amber-950 transition hover:bg-amber-600"
          >
